	...
	<div class="container">
		...
		<div class="panel panel-default" id="input">
			...
			<div class="panel-body" id="demo">
				<form role="form"
					action="${pageContext.request.contextPath}/deparment/insert"
					method="post">
					<div class="form-group">
						<input type="text" class="form-control" id="deparmentName"
							name="deparmentName" placeholder="부서명 (30자 이내)" maxlength="30"
							required="required">
					</div>
