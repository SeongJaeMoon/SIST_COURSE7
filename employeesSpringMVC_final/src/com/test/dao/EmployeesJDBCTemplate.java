...
public class EmployeesJDBCTemplate implements EmployeesDAO {
	...
	public int regionDelete(String reg_id) throws DataAccessException {
		...
		int result = this.jdbcTemplate.update(sql, reg_id);
		return result;
	}
	...
	public int remove(String eid) throws DataAccessException {
		...
		int result = this.jdbcTemplate.update(sql, eid);
		return result;
	}
	...
	public int departmentDelete(String dept_id) throws DataAccessException {
		...
		int result = this.jdbcTemplate.update(sql, dept_id);
		return result;
	}
	...
	public int jobDelete(String job_id) throws DataAccessException {
		...
		int result = this.jdbcTemplate.update(sql, job_id);
		return result;
	}


	@Override
	public int pictureRemove(String eid) throws DataAccessException {
	...
	@Override
	public int modify(Employees emp) throws DataAccessException {
		String sql = "UPDATE employees  SET name_=?, ssn=?, hiredate=?, phone=?, reg_id=?, dept_id=?, job_id=?, basicpay=?, extrapay=? WHERE eid=?";
		int result = this.jdbcTemplate.update(sql, emp.getName_(), emp.getSsn(), emp.getHiredate(), emp.getPhone(), emp.getReg_id(), emp.getDept_id(), emp.getJob_id(), emp.getBasicpay(), emp.getExtrapay(), emp.getEid());
		return result;
	}


	@Override
	public int regionUpdate(Employees emp) throws DataAccessException {
		String sql = "UPDATE regions SET reg_name=? WHERE reg_id=?";
		int result = this.jdbcTemplate.update(sql, emp.getReg_name(), emp.getReg_id());
		return result;
	}


	@Override
	public int departmentUpdate(Employees emp) throws DataAccessException {
		String sql = "UPDATE departments SET dept_name=? WHERE dept_id=?";
		int result = this.jdbcTemplate.update(sql, emp.getDept_name(), emp.getDept_id());
		return result;
	}


	@Override
	public int jobUpdate(Employees emp) throws DataAccessException {
		String sql = "UPDATE jobs SET job_title=?, minBasicPay=? WHERE job_id=?";
		int result = this.jdbcTemplate.update(sql, emp.getJob_title(), emp.getMinBasicPay(), emp.getJob_id());
		return result;
	}
